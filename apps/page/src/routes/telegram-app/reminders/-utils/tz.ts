...
const tzShortOffset = (tz: string): string => {
  try {
...
export const getDeviceTz = (): string => {
  return getDeviceTimeZoneOrDefault();
};

export const resolveTz = (value: string): string => {
...
export const parseWallClockInTz = (
  date: string,
  time: string,
  tz: string,
): Date => {
...
export const addDayToYmd = (s: string): string => {
